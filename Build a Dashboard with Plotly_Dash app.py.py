...
def get_pie_chart(launch_site):
    ...
    if launch_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values='class count', names='class', title=f"Total Success Launches for site {launch_site}")
        return fig
...
def get_payload_chart(launch_site, payload_mass):
    if launch_site == 'ALL':
        ...
        fig = px.scatter(filtered_df[filtered_df['Payload Mass (kg)'].between(payload_mass[0], payload_mass[1])],
                         ...
                         y="class",
                         color="Booster Version Category",
                         title=f'Success count on Payload mass for {launch_site}')
        return fig
